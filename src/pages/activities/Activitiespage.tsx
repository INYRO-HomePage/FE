  ...
  return (
    <div className="min-h-screen text-white font-[Inter] ">
      ...
      <div className="max-w-[1440px] w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col items-center gap-[120px]">
        {/* frame 37 */}
        <div className="flex flex-col items-center justify-end gap-[32px] w-full">
          {/* 소개/활동 버튼 */}
          <div className="flex gap-[45px] items-center mb-[32px]">
            <button
            ...
            <button className="text-lg hover:underline">활동</button>
          </div>
          ...
          <main className="flex flex-col items-center gap-[55px] w-full">
            ...
            <div className="text-center max-w-[800px] px-4">
              <h1 className="text-[48px] sm:text-[64px] lg:text-[80px] font-bold mb-[40px] leading-none">
                Main
              </h1>
            ...
            {/* 활동 카드 */}
            <section className="flex flex-col lg:flex-row items-center justify-center gap-[40px] w-full flex-wrap">
              {/* Study 카드 */}
          ...
          <div className="flex justify-end items-center gap-[50px] self-stretch">
            {/* 연혁 타임라인 컴포넌트 필요*/}
            <HistoryTimeline />
          </div>
        </div>
